import { Swords, Users, Tv, Home, Download } from 'lucide-react';
import React from "react";
import OldMapModal from "./OldMapModal";
                ...
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-6">
                        ...
                        >
                            ...
                            <span className="hidden md:inline">Map Saison 1</span>
                        </button>
                        <OldMapModal openDownload={openDownload} setOpenDownload={setOpenDownload}/>
